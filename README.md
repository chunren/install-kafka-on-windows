...
![environment variable](https://raw.githubusercontent.com/chunren/markdown-src/master/raw/images/environment_variables_chunren_lai_2020.png)

![Java Home](https://raw.githubusercontent.com/chunren/markdown-src/master/raw/images/java_home_chunren_lai_2020.png)
...
![Java home bin](https://raw.githubusercontent.com/chunren/markdown-src/master/raw/images/java_home_bin_chunren_lai_2020.png)
...
- Use 7zip to unzip the ZooKeepr's installation file (e.g., "apache-zookeeper-3.6.2-bin.tar.gz"). You will need to unzip it twice to get the original files.
  ![zookeep unzip](https://raw.githubusercontent.com/chunren/markdown-src/master/raw/images/zookeeper_unzip_chunren_lai_2020.png)
...
- Move the unzipped bin folder to C:\, and rename it as: C:\zookeeper-3.6.2, and you will see:
    ![zookeeper installation folder](https://raw.githubusercontent.com/chunren/markdown-src/master/raw/images/zookeeper_installfolder_chunren_lai_2020.png)
...
![zookeeper home](https://raw.githubusercontent.com/chunren/markdown-src/master/raw/images/zookeeper_home_chunren_lai_2020.png)

 2) to add "%ZOOKEEPER_HOME%\bin" new entry to the System Variable "Path" 

![zookeeper home path](https://raw.githubusercontent.com/chunren/markdown-src/master/raw/images/zookeeper_home_path_chunren_lai_2020.png)
...
![zookeeper running](https://raw.githubusercontent.com/chunren/markdown-src/master/raw/images/zookeeper_running_chunren_lai_2020.png)
...
- Move the unzipped folder to C:\, and rename it as: C:\kafka, and you will see:
    ![kafka installation folder](https://raw.githubusercontent.com/chunren/markdown-src/master/raw/images/kafka_installfolder_chunren_lai_2020.png)
...
```
  3) Now the "StudentImport" has been successfully created. See below:
   ![kafka topic](https://raw.githubusercontent.com/chunren/markdown-src/master/raw/images/kafka_topic_studentImport_chunren_lai_2020.png)
...
```
  3) Now it is ready for you to enter any message in the Producer console. See below:
   ![kafka producer](https://raw.githubusercontent.com/chunren/markdown-src/master/raw/images/kafka_producer_ready_chunren_lai_2020.png)
...
![producer window](https://raw.githubusercontent.com/chunren/markdown-src/master/raw/images/kafka_producer_window_chunren_lai_2020.png)
